...
const Banner = () => {
  return (
    <div className='py-20'>
        ...
        <div className=' w-full h-96 bg-[#088178] flex flex-col gap-10 items-center justify-center bg-[url("/banner/b2.jpg")] bg-no-repeat bg-cover bg-center tablets:max-desktop:h-[30vh] tablets:max-desktop:bg-[right_20%_top_10%] tablets:max-desktop:bg-cover tablets:max-desktop:gap-5 mobile:max-tablets:h-[30vh] mobile:max-tablets:bg-[right_20%_top_10%] mobile:max-tablets:bg-cover mobile:max-tablets:gap-5 '>
