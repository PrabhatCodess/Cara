...
const Hero = () => {
  return (
    <div className=' w-full h-[90vh] bg-[url("/Cara/public/hero4.png")] bg-no-repeat bg-cover flex flex-col items-start justify-center px-28 mb-10 gap-1 tablets:max-desktop:px-10 tablets:max-desktop:bg-[right_30%_top_10%] tablets:max-desktop:h-[70vh] mobile:max-tablets:px-2 mobile:max-tablets:py-1 mobile:max-tablets:bg-[right_35%_top_10%]'>
        ...
        <button className='w-64 h-14 text-lg relative text-[#088178] font-bold  bg-[url("/Cara/public/button.png")] bg-no-repeat bg-cover rounded-full px-26 py-4 mt-5 mobile:max-tablets:right-7 '>Buy Now</button>
    </div>
  )
}
