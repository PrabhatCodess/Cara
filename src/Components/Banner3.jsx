...
const Banner3 = () => {
  return (
    ...
    <div className='w-[33%] h-80 bg-[#088178] flex flex-col gap-5 px-10 items-left justify-center bg-[url("/banner/b7.jpg")] bg-no-repeat bg-cover bg-center tablets:max-desktop:px-1  mobile:max-tablets:w-full '>
    ...
    <div className='w-[33%] h-80 bg-[#088178] flex flex-col px-8 gap-5  items-left justify-center bg-[url("/banner/b4.jpg")] bg-no-repeat bg-cover bg-center tablets:max-desktop:px-1 mobile:max-tablets:w-full '>
    ...
    <div className='w-[33%] h-80 bg-[#088178] flex flex-col  px-10 gap-5 items-left justify-center bg-[url("/banner/b18.jpg")] bg-no-repeat bg-cover bg-center tablets:max-desktop:px-1 mobile:max-tablets:w-full '>
