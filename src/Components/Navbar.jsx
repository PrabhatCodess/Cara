...
const Navbar = () => { 
  ...
  mobile:max-tablets:flex-col mobile:max-tablets:items-start mobile:max-tablets:justify-start mobile:max-tablets:gap-5 mobile:max-tablets:fixed mobile:max-tablets:top-0 mobile:max-tablets:transition-all mobile:max-tablets:duration-300 mobile:max-tablets:h-full mobile:max-tablets:w-64 mobile:max-tablets:bg-[#E3E6F3] mobile:max-tablets:shadow-2xl mobile:max-tablets:p-10 ${isNavOpen ? "tablets:max-desktop:right-[-50px] mobile:max-tablets:right-[-100px]" : "tablets:max-desktop:right-[-200%] mobile:max-tablets:right-[-200%]"}`}>
        ...
        <NavLink to="/" className='after:content-[" "] after:w-[28px] after:h-[3px] after:bg-[#088178] after:absolute after:left-[0%] after:bottom-[0px] 
         hover:text-[#088178] transition-colors'>Home</NavLink>
        ...
        <NavLink to="/blog" className='hover:text-[#088178] transition-colors tablets:max-desktop:after:top-[14.7%] tablets:max-desktop:after:left-10 mobile:max-tablets:after:top-[21.5%] mobile:max-tablets:after:left-10'>Blog</NavLink>

        <NavLink to="/about" className='hover:text-[#088178] transition-colors tablets:max-desktop:after:top-[18.2%] tablets:max-desktop:after:left-10 mobile:max-tablets:after:top-[26.5%] mobile:max-tablets:after:left-10'>About</NavLink>

        <NavLink to="/contact" className='hover:text-[#088178] transition-colors tablets:max-desktop:after:top-[21.9%] tablets:max-desktop:after:left-10 mobile:max-tablets:after:top-[31.8%] mobile:max-tablets:after:left-10'>Contact</NavLink>
