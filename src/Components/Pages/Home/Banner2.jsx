...
const Banner2 = () => {
  return (
    <div className='flex items-center justify-between px-14 py-10 gap-10 tablets:max-desktop:flex-col tablets:max-desktop:gap-5 tablets:max-desktop:px-0 sm:flex-col sm:gap-5 sm:px-0 mobile:flex-col mobile:gap-5 mobile:px-0 '>

        <div className='w-1/2 h-96 bg-[#088178] flex flex-col gap-2 px-10 items-left justify-center bg-[url("/src/images/banner/b17.jpg")] bg-no-repeat bg-cover bg-center tablets:max-desktop:w-full tablets:max-desktop:h-[50vh] sm:w-full sm:h-[40vh] sm:px-5 mobile:w-full'>
        ...
        <div className='w-1/2 h-96 bg-[#088178] flex flex-col gap-2 px-10 items-left justify-center bg-[url("/src/images/banner/b10.jpg")] bg-no-repeat bg-cover bg-center tablets:max-desktop:w-full tablets:max-desktop:h-[50vh] sm:w-full sm:h-[40vh] sm:px-5 mobile:w-full'>
