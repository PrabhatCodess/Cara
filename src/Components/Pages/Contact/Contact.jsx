...
const Contact = () => {
  ...
  mobile:max-tablets:flex-col mobile:max-tablets:items-start mobile:max-tablets:justify-start mobile:max-tablets:gap-5 mobile:max-tablets:fixed mobile:max-tablets:top-0 mobile:max-tablets:transition-all mobile:max-tablets:duration-300 mobile:max-tablets:h-full mobile:max-tablets:w-64 mobile:max-tablets:bg-[#E3E6F3] mobile:max-tablets:shadow-2xl mobile:max-tablets:p-10 ${isNavOpen ? "tablets:max-desktop:right-[-50px] mobile:max-tablets:right-[-100px]" : "tablets:max-desktop:right-[-200%] mobile:max-tablets:right-[-200%]"}`}>
      ...
      <h1 className='text-white text-6xl font-extrabold relative left-14 mobile:max-tablets:text-5xl mobile:max-tablets:left-0 tablets:max-desktop:left-10 '>#let's_talk</h1>
      <p className='text-white text-2xl font-light relative left-14 mobile:max-tablets:text-sm mobile:max-tablets:left-7  tablets:max-desktop:text-xl '>LEAVE A MESSAGE,We love to hear form you!</p>
     </div>
     ...
     <div className="contact-container flex items-center justify-between px-0 py-10 ">
      ...
      <div className="contact-left  w-1/2 h-full flex flex-col gap-3 justify-center px-20 ">
        ...
        <h5 className='uppercase text-[#0000007e] '>Get In Touch</h5>
        <h1 className='text-5xl'>Visit one of our agency locations <br /> or contact us today</h1>
        <h1 className='text-2xl'>Head Office</h1>

        <div>
        <div className='flex flex-col gap-3'>

          <div className='flex gap-4 capitalize text-lg text-[#0000008f] '>
        ...
        <i className="fa-solid fa-phone"></i>contact@example.com 
          ...
          <div className='flex gap-4 text-lg text-[#0000008f] '>
    ...
    ></iframe>
     ...
     <div className="form-container h-[100vh] w-full flex shadow-2xl px-10">

      <div className="form-left h-[85vh] w-2/3 px-20 py-10  ">
        <form className='flex flex-col gap-5 px-10 py-10'>
        <h5 className='uppercase text-[#00000060]'>Leave a message </h5>
        <h1 className='capitalize text-5xl'>We love to hear form you</h1>

          <input className='w-[35vw] h-10 px-2 text-md font-bold outline outline-[#ccc] outline-[0.1px]  '  type="text" placeholder="Your Name" />
          <input className='w-[35vw] h-10 px-2 text-md font-bold outline outline-[#ccc] outline-[0.1px]  ' type="text" placeholder="Your Email" />
          <input className='w-[35vw] h-10 px-2 text-md font-bold outline outline-[#ccc] outline-[0.1px]  ' type="text" placeholder="Your Phone Number" />
          <input className='w-[35vw] h-10 px-2 text-md font-bold outline outline-[#ccc] outline-[0.1px]  ' type="text" placeholder="Your Subject" />
          <textarea className='w-[35vw] resize-none h-64 px-2 text-md font-bold outline outline-[#ccc] outline-[0.1px]  ' placeholder="Your Message" />
      ...
      <div className="form-right w-1/3 h-full flex flex-col gap-5 px-5 py-20   ">
