...
const Newsletter = () => {
  return (
    <div className='py-20'>
        ...
        <div className="newsletter-container w-full h-[22vh] px-28 py-0 bg-[#041e42] flex items-center justify-between gap-10 bg-[url('./banner/b14.png')] bg-no-repeat bg-[20%_30%] tablets:max-desktop:px-20  tablets:max-desktop:bg-[20%_30%] tablets:max-desktop:flex-col tablets:max-desktop:items-start tablets:max-desktop:justify-center tablets:max-desktop:py-0  tablets:max-desktop:gap-5
